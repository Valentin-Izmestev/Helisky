...
let path = {
    ...
    build:{
        html: project_folder +"/",
        css: project_folder + "/local/templates/hely/css/",
        js: project_folder +"/local/templates/hely/js/",
        img: project_folder +"/local/templates/hely/img/",
        image: project_folder +"/local/templates/hely/image/",
        video: project_folder +"/local/templates/hely/video/",
        fonts: project_folder +"/local/templates/hely/fonts/"
    },
    //исходники
    src:{ 
        html: [source_folder +"/*.html", "!" + source_folder +"/_*.html"],
        scss: source_folder +"/local/templates/hely/scss/style.scss",
        js: source_folder +"/local/templates/hely/js/script.js",
        img: source_folder +"/local/templates/hely/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/hely/image/**/*.{jpg,png,svg,gif,ico,webp}",
        video: source_folder +"/local/templates/hely/video/**/*.{mp4,ogv,webm}",
        fonts: source_folder + "/local/templates/hely/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
    // пути папок за которыми нужно будет следить
    watch:{
        html: source_folder +"/**/*.html",
        scss: source_folder +"/local/templates/hely/scss/**/*.scss",
        js: source_folder +"/local/templates/hely/js/**/*.js",
        img: source_folder +"/local/templates/hely/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/local/templates/hely/image/**/*.{jpg,png,svg,gif,ico,webp}",
        video: source_folder +"/local/templates/hely/video/**/*.{mp4,ogv,webm}",
        fonts: source_folder + "/local/templates/hely/fonts/**/*.{eot,ttf,woff,woff2,svg}"
...
gulp.task('svgSprite', function(){ 
    return gulp.src('src/local/templates/hely/img/for-svg-icon/*.svg')
        .pipe(svgSprite({
            mode:{
                stack:{
        ...
        .pipe(dest('src/local/templates/hely/img/'))
});
