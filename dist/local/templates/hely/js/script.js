...
// about-section
gsap.fromTo('.about-us-container',{y: 200},{scrollTrigger: ".about-section ", y: 0, ease:  "power1.out", duration: 0.7});  
gsap.fromTo('.partners-inner',{y: 200},{scrollTrigger: ".about-us-container", y: 0, ease:  "power1.out", duration: 0.7}, '-=0.5'); 
...
if(window.innerWidth > 950){
    ...
    if(nlNewsItem.length > 0){
        nlNewsItem.forEach(elem=>{
            console.log(elem)
            gsap.fromTo(elem, {y: 200}, {scrollTrigger: elem, y: 0, ease:  "power1.out", duration: 0.5,  delay: 0}, );
        })
...
servicesTL.fromTo('.services-section .section-title',{y: 200},{ y: 0, ease:  "power1.out", duration: 0.7})
        .fromTo('.services-section .hely-spoiler-box',{y: 200},{ y: 0, ease:  "power1.out", duration: 0.5}, '-=0.5') 
        .fromTo('.services-section .world-map-img',{y: 200},{ y: 0, ease:  "power1.out", duration: 0.5}, '-=0.3'); 
